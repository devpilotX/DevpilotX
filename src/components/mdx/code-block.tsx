...
// The full bundle loads each grammar on demand, so posts can use languages
// like dockerfile and nginx that the smaller web bundle leaves out.
...
export function CodeBlock({ children, ...props }: CodeBlockProps) {
  ...
  const handleCopy = async () => {
    // Read from <code> only, so the filename header is not copied along.
